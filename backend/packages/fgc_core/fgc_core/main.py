...
from fgc_core.database import init_db
from fgc_core.routers import (
    auth,
    equipment,
    network,
    projects,
...
async def _seed_admin():
    ...
    from fgc_core.database import async_session
    from fgc_core.models.user import User
    from fgc_core.services.auth_service import hash_password
